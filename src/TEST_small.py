...
Description:
    Tests the algorithm on a small applicant pool, manually inputted for maximum control. Note, the interesting applicant names were generated by ChatGPT. Test cases and expected outputs are described in comments in comments and print statements.
'''
